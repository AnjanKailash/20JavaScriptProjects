...
//Below code is VoiceRSS api SDK
...
//Below code is mine and not VoiceRSS SDK
function speech(joke) {
    VoiceRSS.speech({
        key: 'baa0b87d2a944bf09d8128f49e9fb6e0',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes() {
    let joke = '';
    const apiUrl = 'https://sv443.net/jokeapi/v2/joke/Programming?blacklist=nsfw,religious,political,sexist';
    try {
